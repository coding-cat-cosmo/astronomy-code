...
#print("orig rest_wavelengths and size", rest_wavelengths, rest_wavelengths.shape)
#mu = model['mu']
#print("orig mu and size", mu, mu.shape)
#M = model['M']
#print("orig M and size", M, M.shape)
#log_omega = model['log_omega']
#print("orig log_omega and size", log_omega, log_omega.shape)
#log_c_0 = model['log_c_0']
#print("orig log_c_0 and size", log_c_0, log_c_0.shape)
#log_tau_0 = model['log_tau_0']
#print("orig log_tau_0 and size", log_tau_0, log_tau_0.shape)
#log_beta = model['log_beta']
#print("orig log_beta and size", log_beta, log_beta.shape)
#bluewards_mu = model['bluewards_mu']
#print("orig bluewards_mu and size", bluewards_mu, bluewards_mu.shape)
#bluewards_sigma = model['bluewards_sigma']
#print("orig bluewards_sigma and size", bluewards_sigma, bluewards_sigma.shape)
#redwards_mu = model['redwards_mu']
#print("orig redwards_mu and size", redwards_mu, redwards_mu.shape)
#redwards_sigma = model['redwards_sigma']
#print("orig redwards_sigma and size", redwards_sigma, redwards_sigma.shape)
