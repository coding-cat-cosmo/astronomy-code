...
#    instrument_profile[i] /= total;
  ...
  #mwSize num_points;
    ...
    def sample_analysis(offset_samples_qso, this_out_wavelengths, this_out_flux, this_out_noise_variance,
                    this_out_pixel_mask, z_qso, bluewards_mu, bluewards_sigma, redwards_mu, redwards_sigma,
                    fluxes, rest_wavelengths, orig_z_qsos, dla_ind, this_p_dlas, c_0, tau_0, beta,
                    prev_tau_0, prev_beta, occams_factor, quasar_ind, i, offset_samples, nhi_samples,
                    min_z_dlas, max_z_dlas, this_sample_log_priors_no_dla, this_sample_log_priors_dla,
                    this_sample_log_likelihoods_no_dla, this_sample_log_likelihoods_dla):
    ...
    if (np.count_nonzero(this_rest_wavelengths) < 1):
        ...
        return [fluxes, rest_wavelengths, min_z_dlas, max_z_dlas, this_sample_log_priors_no_dla,
                this_sample_log_priors_dla, this_sample_log_likelihoods_no_dla, this_sample_log_likelihoods_dla]
...
for quasar_ind in range(q_ind_start, num_quasars): #quasar list
    ...
    for i in range(2):  #variant redshift in quasars 
        [fluxes, rest_wavelengths, min_z_dlas, max_z_dlas, this_sample_log_priors_no_dla,
         this_sample_log_priors_dla, this_sample_log_likelihoods_no_dla,
         this_sample_log_likelihoods_dla] = sample_analysis(offset_samples_qso, this_out_wavelengths, this_out_flux,
                                                            this_out_noise_variance, this_out_pixel_mask, z_qso,
                                                            ...
                                                            quasar_ind, i, offset_samples, nhi_samples, min_z_dlas,
                                                            max_z_dlas, this_sample_log_priors_no_dla,
                                                            this_sample_log_priors_dla, this_sample_log_likelihoods_no_dla,
                                                            this_sample_log_likelihoods_dla)
